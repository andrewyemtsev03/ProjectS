import { getCountryName, getCountryRegion } from "./countries-data.js?v=worldwide-9";
...
export class CountryInfoCard {
  ...
  setLanguage(lang) {
    this.lang = localizedCopy[lang] ? lang : "en";
  }
  ...
  buildCard(country) {
    ...
    const backLink = createLink("#country-overview", copy.back, "country-info-card__back");
  ...
  appendRows(container, country) {
    ["locationTitle", "address", "website", "email", "phone"].forEach((field) => {
